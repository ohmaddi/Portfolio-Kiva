...
# Cam: That's a really impressive amount of data! I did have a bit of problem importing without `here()`, but other than that it worked fine.
...
kiva_words <- kiva_words %>%
  ...
  filter(word != "buy",
         ...
         word != "purchase",
         word != "pay",
         word != "business") # Cam: Since I would assume that almost all Kiva loans include the word buy, sell, purchase, pay, busines, etcetera, I would likely treat these as stop word. I think is very illuminating to see water is one of the most used waters in Kiva loans.
...
=======
  scale_color_distiller(palette = "Spectral") # Cam: I did not know that this existed! Being able to change disscrete palettes to continuous palettes is a game change!
>>>>>>> 67146744e959cfca50dfeb525a19130bcd5d25c4
```
